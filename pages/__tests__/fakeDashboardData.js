  ...
  resources: {
    MedicationOrder: {
      ...
      entry: [
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e5125f98837ddbb0e3c58ee5d4a21028f2f6c8',
          search: {
            mode: 'match',
          },
          resource: {
            dosageInstruction: [
              {
                ...
                text:
                  'Take 1 tablet (2 mg total) by mouth 2 (two) times a day before meals.',
                route: {
                  coding: [
                    {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e51abf1ccafe879273191406236353093c8a7f',
          search: {
            mode: 'match',
          },
          resource: {
            ...
            medicationReference: {
              ...
              display:
                'amphetamine-dextroamphetamine XR (ADDERALL XR) 15 MG 24 hr capsule',
            },
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e5301dec99a00efc990b111024b2c665ffaabf',
          search: {
            mode: 'match',
          },
          resource: {
            dosageInstruction: [
              {
                ...
                text:
                  'Chew 1 tablet (160 mg total) every 6 (six) hours as needed for mild pain for up to 10 days.',
                route: {
                  coding: [
                    {
                      system: 'urn:oid:1.2.840.114350.1.13.0.1.7.4.698288.330',
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e536a9edcb3f1fc4e9e758de5238f6fe892ee8',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e53b00f9521369c36c9a1964f4ecd9d8649c29',
          search: {
            mode: 'match',
          },
          resource: {
            dosageInstruction: [
              {
                asNeededBoolean: false,
                text:
                  'Take 1 tablet (100 mg total) by mouth 3 (three) times a day before meals.',
                route: {
                  coding: [
                    {
                      system: 'urn:oid:1.2.840.114350.1.13.0.1.7.4.698288.330',
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e54a2b0f5398a7c17575d150baba055dffa9f5',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e5540b38082d46f7e94ba0557eb200ea50ba51',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e581297ab3b8f639bb2d63e3ac81544f6878ab',
          search: {
            mode: 'match',
          },
          resource: {
            dosageInstruction: [
              {
                asNeededBoolean: true,
                text:
                  'Take 1 tablet (650 mg total) by mouth every 8 (eight) hours as needed for mild pain for up to 10 days.',
                route: {
                  coding: [
                    {
                      system: 'urn:oid:1.2.840.114350.1.13.0.1.7.4.698288.330',
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e586c5292346296975d530bf154f88a20e1ad5',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/MedicationOrder/f8fedcd9e6e599c378f066c5537afbd4ae6c625d50925f4c',
          search: {
            mode: 'match',
          },
          resource: {
    ...
    AllergyIntolerance: {
      ...
      entry: [
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/AllergyIntolerance/f8fedcd9e6e597f922acfb817fa71844de0c894d88bfd7c1',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/AllergyIntolerance/f8fedcd9e6e5c8e896b10440cf41c391874d400c0402e8bf',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/AllergyIntolerance/f8fedcd9e6e5dc5963ef895e051d5e3df838e348eadce761',
          search: {
            mode: 'match',
          },
          resource: {
    ...
    Observation: {
      ...
      entry: [
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e5036e9d131bf04809e1abb60bb27899c599bc',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e504829903a55284cc88babb16d6f3d78b50da',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e5064e1161dd2d34440579204387cb880e7205',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e507b84e6b62a69a32852cc0745af6627d0881',
          search: {
            mode: 'match',
          },
          resource: {
            ...
            code: {
              ...
              text:
                'ERYTHROCYTE MEAN CORPUSCULAR HEMOGLOBIN [PG] BY AUTOMATED COUNT',
            },
            resourceType: 'Observation',
            category: {
              coding: [
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e51103f635585454879a24d189e9b3f1baaf92',
          search: {
            mode: 'match',
          },
          resource: {
            ...
            identifier: [
              {
                value:
                  'Tnf7t0.SP6znu2Dc1kPsrog5qrfqH33vJQOxAByVedwC-xFrBhsufKRxbYH1hARD8B',
                system: 'https:open-ic.epic.com',
              },
            ],
            meta: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e5150462fb6548007e4ee5723ec977183d668e',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e5164ecdcb7487bfe3e86630a5d097ff3555cd',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e51a52576b97ed214321599008c78080ac2631',
          search: {
            mode: 'match',
          },
          resource: {
            ...
            identifier: [
              {
                value:
                  'Tnf7t0.SP6znu2Dc1kPsrog5qrfqH33vJQOxAByVedwC2C0rv4mz1Yn.XbBMaol8RB',
                system: 'https:open-ic.epic.com',
              },
            ],
            meta: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e51f87eec6fce84519f33036cc32796ca5a8f6',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Observation/f8fedcd9e6e52289ee9aae759fafb584481c82d7262ee0a2',
          search: {
            mode: 'match',
          },
          resource: {
      ...
      link: [
        ...
        },
        {
          relation: 'next',
          url:
            'https://api.1up.health/fhir/dstu2/Observation?_afterid=f8fedcd9e6e52289ee9aae759fafb584481c82d7262ee0a2',
        },
      ],
    },
    MedicationStatement: {
          ...
          resource: {
            ...
            extension: [
              ...
              },
              {
                ...
                url:
                  'http://hl7.org/fhir/StructureDefinition/us-core-birth-sex',
              },
            ],
            telecom: [
              {
    ...
    Condition: {
      ...
      entry: [
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Condition/f8fedcd9e6e51b76b16b7a84dac69e1fdffd7637b77f3ae8',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Condition/f8fedcd9e6e51d9bd5d973334b9da14c159a540cc6562dd5',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Condition/f8fedcd9e6e5376c64785b303a5aedf76aebba93d775384f',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Condition/f8fedcd9e6e541eaedde7488e6b6d0ddf8d2b8d65f93896a',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Condition/f8fedcd9e6e55d1cea835eee38cfc585cf00f72211fa99a5',
          search: {
            mode: 'match',
          },
          resource: {
        ...
        {
          fullUrl:
            'https://api.1up.health/fhir/dstu2/Condition/f8fedcd9e6e5c5de892a33dd2aa558f8956457ea99c8ead9',
          search: {
            mode: 'match',
          },
          resource: {
